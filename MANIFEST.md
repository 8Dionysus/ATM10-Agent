...
- Текущий status tests: `156 passed` (`python -m pytest`)
...
- Trend snapshot: `scripts/kag_guardrail_trend_snapshot.py` (rolling-baseline + regression flags).
...
- Session history: `docs/SESSION_2026-02-23.md`
